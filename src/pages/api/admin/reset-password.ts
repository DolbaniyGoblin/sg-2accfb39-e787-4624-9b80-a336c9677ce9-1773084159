...
export default async function handler(
  ...
  try {
    ...
    console.log("SUPABASE_SERVICE_ROLE_KEY starts:", supabaseServiceKey?.substring(0, 10));
    console.log("SUPABASE_SERVICE_ROLE_KEY ends:", supabaseServiceKey?.substring((supabaseServiceKey?.length || 0) - 10));
